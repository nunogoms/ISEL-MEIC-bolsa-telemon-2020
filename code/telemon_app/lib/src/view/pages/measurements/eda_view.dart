...
import 'package:telemon_app/src/model/device/sensors/eda_sensor_data.dart';
...
class EdaView extends StatelessWidget {
  var currSensor = EdaSensorData();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: BackTitleAppbar("Analise Electrodermica").build(context),
